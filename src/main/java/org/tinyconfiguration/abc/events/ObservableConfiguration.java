...
public interface ObservableConfiguration<T extends AbstractConfiguration> {
     ...
     */
    boolean addListener(ConfigurationEvent.Type type, ConfigurationListener<T> listener);
     ...
     */
    boolean removeListener(ConfigurationEvent.Type type, ConfigurationListener<T> listener);
     ...
     */
    List<ConfigurationListener<T>> getListeners(ConfigurationEvent.Type type);
