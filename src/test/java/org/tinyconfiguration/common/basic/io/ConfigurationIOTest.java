...
class ConfigurationIOTest {
    ...
    void writeJSON() {
        ...
        assertDoesNotThrow(() -> {
            ...
            io.getHandlerJSON().write(this.instance);
    ...
    void writeAsyncJSON() {
        ...
        assertDoesNotThrow(() -> {
            ...
            Future<Void> task = io.getHandlerJSON().writeAsync(this.instance);
    ...
    void readJSON() {
        ...
        assertDoesNotThrow(() -> {
            ...
            io.getHandlerJSON().read(this.instance);
    ...
    void readAsyncJSON() {
        ...
        assertDoesNotThrow(() -> {
            ...
            Future<Void> task = io.getHandlerJSON().readAsync(this.instance);
    ...
    void deleteJSON() {
        ...
        assertDoesNotThrow(() -> {
            ...
            io.getHandlerJSON().delete(instance);
        });
    }
